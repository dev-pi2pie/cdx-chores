...
- `docs/plans/archive/plan-2026-03-31-data-query-workspace-implementation.md` reflects the first shipped workspace implementation, including the earlier decision to reserve `file` in workspace mode.
- the later follow-up alias decision that frees explicit workspace `file` bindings is tracked separately in `docs/researches/archive/research-2026-03-31-workspace-file-alias-reservation-reconsideration.md`
- that follow-up has now been implemented in `docs/plans/archive/plan-2026-03-31-data-query-workspace-alias-followup.md`, including comma-separated `--relation` bundles while keeping explicit aliasing for dotted selectors
- the separate future family for directory-pattern multi-file relation assembly is now tracked in `docs/researches/archive/research-2026-04-23-data-stack-multi-file-assembly.md`
