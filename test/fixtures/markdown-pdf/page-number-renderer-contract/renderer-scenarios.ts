...
`,
    expected: {
      ...
      pages: [
        { role: "cover", marker: "PAGE-COVER-1", pageNumberLabels: [] },
        { role: "cover", marker: "PAGE-COVER-2", pageNumberLabels: [] },
        {
          role: "metadata-title",
          marker: "PAGE-FRONT-1",
          pageNumberLabels: ["PN-DOC-3/7"],
        },
        {
          role: "table-of-contents",
          marker: "PAGE-TOC-1",
          pageNumberLabels: ["PN-DOC-4/7"],
        },
        {
          role: "table-of-contents",
          marker: "PAGE-TOC-2",
          pageNumberLabels: ["PN-DOC-5/7"],
        },
        { role: "document-body", marker: "PAGE-BODY-1", pageNumberLabels: ["PN-DOC-6/7"] },
        { role: "document-body", marker: "PAGE-BODY-2", pageNumberLabels: ["PN-DOC-7/7"] },
      ],
      pngPages: [1, 3, 5, 6, 7],
    },
  },
...
`,
    expected: {
      ...
      pages: [
        {
          role: "document-body",
          marker: "PAGE-DOC-RESET-1",
          pageNumberLabels: ["PN-DOC-RESET-0/3"],
        },
        {
          role: "document-body",
          marker: "PAGE-DOC-RESET-2",
          pageNumberLabels: ["PN-DOC-RESET-2/3"],
        },
        {
          role: "document-body",
          marker: "PAGE-DOC-RESET-3",
          pageNumberLabels: ["PN-DOC-RESET-4/3"],
        },
      ],
      pngPages: [1, 2, 3],
    },
...
`,
    expected: {
      ...
      pages: [
        { role: "cover", marker: "PAGE-COVER-1", pageNumberLabels: [] },
        { role: "table-of-contents", marker: "PAGE-TOC-1", pageNumberLabels: [] },
        { role: "document-body", marker: "PAGE-BODY-1", pageNumberLabels: ["PN-BODY-0/5"] },
        { role: "document-body", marker: "PAGE-BODY-2", pageNumberLabels: ["PN-BODY-2/5"] },
        { role: "document-body", marker: "PAGE-BODY-3", pageNumberLabels: ["PN-BODY-4/5"] },
      ],
      pngPages: [2, 3, 4, 5],
    },
  },
...
`,
    expected: {
      ...
      pages: [
        { role: "other", marker: "PAGE-POS-TOP-LEFT", pageNumberLabels: ["PN-POS-TL-1"] },
        {
          role: "other",
          marker: "PAGE-POS-TOP-CENTER",
          pageNumberLabels: ["PN-POS-TC-2"],
        },
        { role: "other", marker: "PAGE-POS-TOP-RIGHT", pageNumberLabels: ["PN-POS-TR-3"] },
        {
          role: "other",
          marker: "PAGE-POS-BOTTOM-LEFT",
          pageNumberLabels: ["PN-POS-BL-4"],
        },
        {
          role: "other",
          marker: "PAGE-POS-BOTTOM-CENTER",
          pageNumberLabels: ["PN-POS-BC-5"],
        },
        {
          role: "other",
          marker: "PAGE-POS-BOTTOM-RIGHT",
          pageNumberLabels: ["PN-POS-BR-6"],
        },
      ],
...
`,
    expected: {
      ...
      pages: [
        {
          role: "document-body",
          marker: "PAGE-BLANK-LEAD",
          pageNumberLabels: ["PN-BLANK-1/3"],
        },
        { role: "inserted-blank", marker: "", pageNumberLabels: ["PN-BLANK-2/3"] },
        {
          role: "document-body",
          marker: "PAGE-BLANK-RIGHT",
          pageNumberLabels: ["PN-BLANK-3/3"],
        },
      ],
      pngPages: [1, 2, 3],
    },
...
`,
    expected: {
      ...
      orientation: "portrait",
      pages: [
        { role: "metadata-title", marker: "PAGE-SENTINEL-PRE", pageNumberLabels: [] },
        {
          role: "document-body",
          marker: "PAGE-SENTINEL-BODY-1",
          pageNumberLabels: ["PN-SENTINEL-20"],
        },
        {
          role: "document-body",
          marker: "PAGE-SENTINEL-BODY-2",
          pageNumberLabels: ["PN-SENTINEL-21"],
        },
        {
          role: "document-body",
          marker: "PAGE-SENTINEL-BODY-3",
          pageNumberLabels: ["PN-SENTINEL-22"],
        },
      ],
      pngPages: [2, 4],
    },
