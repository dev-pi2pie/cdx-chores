...
Markdown PDF profile and template workflows are direct CLI flows in the current canary line; interactive Markdown PDF and Codex-assisted PDF helper flows are deferred to a later release.
