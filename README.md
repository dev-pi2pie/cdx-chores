...
- `md to-docx` via `pandoc`, Markdown-to-PDF rendering via WeasyPrint, and Markdown PDF profile/template/project helpers
...
The Codex SDK baseline for `v0.1.9-canary.1` is `@openai/codex-sdk` `0.154.0`.
