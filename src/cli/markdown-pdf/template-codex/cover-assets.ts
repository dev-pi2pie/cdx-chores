...
function imageFormatForPath(path: string): MarkdownPdfTemplateCodexCoverImageSignals["format"] {
...
async function readImageDimensions(
  path: string,
  format: MarkdownPdfTemplateCodexCoverImageSignals["format"],
...
export async function collectTemplateCodexCoverImageSignals(
  ...
  const dimensions = await readImageDimensions(path, format);
